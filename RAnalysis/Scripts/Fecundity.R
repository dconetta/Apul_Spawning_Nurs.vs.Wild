...
dev.off()
bargraph.CI(x.factor = Sample_ID, response = fecundity, data = Oct.fec, xlab = "Colony ID", ylab = "Fecundity (eggs/cm2)", group = Origin, col = c("red", "blue"), legend = TRUE, ylim =c(0,60))
